...
public class Elevator {
    ...
    public static final PIDController positionPid;
    public static final CANPIDController velocityPid;
    ...
    static {
        ...
        positionPid.setContinuous(false);
        positionPid.setInputRange(0, MAX_POSITION);
        positionPid.setOutputRange(-MAX_VELOCITY, MAX_VELOCITY);
        positionPid.enable();
    ...
    public static void stop() {
        ...
        velocityPid.setReference(0, ControlType.kVelocity);
    }
